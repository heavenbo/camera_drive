...
private:                                                      // 参数
    ...
    VPIImageData vpiData_left, vpiData_right;
    VPIImage vpiimage_left, vpiimage_right;
    VPIImageWrapperParams nvpar_left, nvpar_right;
    NvBufSurfaceAllocateParams input_params_left = {{0}};  // nvbuffer输入
    NvBufSurfaceAllocateParams input_params_right = {{0}}; // nvbuffer输入
    NvBufSurface *src_nvbuf_surf_left = 0;                 // 输入的nvbuffer
    NvBufSurface *src_nvbuf_surf_right = 0;                // 输入的nvbuffer
